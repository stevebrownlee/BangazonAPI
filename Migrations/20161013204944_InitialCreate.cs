    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerFaveId = table.Column<int>(nullable: false)
                        .Annotation("Autoincrement", true),
                    CustomerId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerFave", x => x.CustomerFaveId);
                    table.ForeignKey(
                        name: "FK_CustomerFave_Customer_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customer",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerFave_Product_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerFave_CustomerId",
                table: "CustomerFave",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerFave_ProductId",
                table: "CustomerFave",
                column: "ProductId");
