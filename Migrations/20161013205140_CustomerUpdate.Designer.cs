...
namespace BangazonAPI.Migrations
{
    ...
    [Migration("20161013205140_CustomerUpdate")]
    partial class CustomerUpdate
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Bangazon.Models.CustomerFave", b =>
                {
                    b.Property<int>("CustomerFaveId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("CustomerFaveId");

                    b.HasIndex("CustomerId");

                    b.HasIndex("ProductId");

                    b.ToTable("CustomerFave");
                });
